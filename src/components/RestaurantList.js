    ...
    render() {
        return (
            <span>
                ...
                <span dangerouslySetInnerHTML={{__html: this.props.food.name}}/>
                &nbsp;
                        ...
                        <ul>
                            {this.props.restaurant.foods
                                .map((value, index) => {
                                    ...
                                    let food = <Food key={index} food={value} user={this.props.user} likedBy={likedBy}/>;

                                    if (this.props.restaurant.foods.length > 1)
                                        return <li>{food}</li>;
                                    else
                                        return food;
